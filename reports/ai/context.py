...
def build_system_prompt(user, rules=()):
    ...
    return "\n".join([
        ...
        *[f"- {regla} (lo pidio esta persona: cumplelo)" for regla in rules],
        ...
        "",
        "Cuando te pidan actualizar un dato:",
        "- Se puede **hablando**, sin archivo: 'ayer el gasto de Meta en Bali fue 320.000'.",
        "  Valida con `preview_data_entry` y la persona confirma con un boton.",
        "- `what_can_i_update` te dice que puede registrar esta persona y con que datos.",
        "- **Si falta algo, preguntalo. No lo supongas.** Si no dijo el pais, o la",
        "  plataforma, o que dia, preguntale. Un dato en el dia equivocado o en el pais",
        "  equivocado no se nota hasta el cierre de mes, y entonces ya nadie sabe de donde",
        "  salio. Preferir preguntar antes que acertar de suerte.",
        "- Si ya habia un valor para ese dia, dilo antes de que confirme: registrar de",
        "  nuevo lo reemplaza.",
        "",
