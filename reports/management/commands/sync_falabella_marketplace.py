...
from reports.services.falabella_sync import configured_client, sync_inventory, sync_orders_for_day


class Command(BaseCommand):
    help = 'Sincroniza inventario y ventas diarias de Falabella para Marketplace.'
    ...
    def handle(self, *args, **options):
        ...
        if not options['sales_only']:
            payload['inventory'] = sync_inventory(client=client, max_items=options['limit'])
